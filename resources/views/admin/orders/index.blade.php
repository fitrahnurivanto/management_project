    ...
    <div class="bg-white rounded-xl shadow-sm mb-6">
        <div class="border-b border-gray-200">
            <nav class="flex -mb-px">
                <a href="{{ route('admin.orders.index') }}" class="px-6 py-3 border-b-2 {{ !request('status') ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-gray-600 hover:text-gray-800 hover:border-gray-300' }} font-medium text-sm">
                    <i class="fas fa-list mr-2"></i> Semua Order
                </a>
                <a href="{{ route('admin.orders.index', ['status' => 'pending_review']) }}" class="px-6 py-3 border-b-2 {{ request('status') == 'pending_review' ? 'border-yellow-600 text-yellow-600' : 'border-transparent text-gray-600 hover:text-gray-800 hover:border-gray-300' }} font-medium text-sm">
                ...
                <a href="{{ route('admin.orders.index', ['status' => 'paid']) }}" class="px-6 py-3 border-b-2 {{ request('status') == 'paid' ? 'border-green-600 text-green-600' : 'border-transparent text-gray-600 hover:text-gray-800 hover:border-gray-300' }} font-medium text-sm">
                    <i class="fas fa-check-circle mr-2"></i> Terkonfirmasi
                </a>
                <a href="{{ route('admin.orders.index', ['status' => 'rejected']) }}" class="px-6 py-3 border-b-2 {{ request('status') == 'rejected' ? 'border-red-600 text-red-600' : 'border-transparent text-gray-600 hover:text-gray-800 hover:border-gray-300' }} font-medium text-sm">
                ...
                <div class="ml-auto flex items-center px-4 gap-3">
                    ...
                    <div class="flex items-center">
                        ...
                        <select onchange="window.location.href='{{ route('admin.orders.index') }}?division=' + this.value + '{{ request('status') ? '&status=' . request('status') : '' }}' + '{{ request('year') ? '&year=' . request('year') : '' }}'" class="text-sm border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            @endphp
                            <a href="https://wa.me/{{ $cleanPhone }}?text=Halo%20{{ urlencode($clientName) }},%20mengenai%20order%20{{ $order->order_number }}" target="_blank" class="text-center text-green-600 hover:text-green-800 font-medium px-3 py-1 border border-green-600 rounded hover:bg-green-50">
