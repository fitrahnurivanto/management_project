...
<div class="p-6 max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-3 mb-2">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Edit Trainer</h1>
        </div>
        <p class="text-gray-600 ml-9">Perbarui data trainer {{ $trainer->name }}</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        <form action="{{ route('admin.trainer.update', $trainer) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="expertise" id="expertise" value="{{ old('expertise', $trainer->expertise) }}"
            ...
            <div class="mb-6">
                ...
                <textarea name="bio" id="bio" rows="4"
                          ...
                          placeholder="Ceritakan pengalaman dan latar belakang trainer...">{{ old('bio', $trainer->bio) }}</textarea>
                @error('bio')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
