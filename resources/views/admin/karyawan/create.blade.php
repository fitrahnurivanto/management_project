...
<div class="p-6">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            ...
            <p class="text-gray-600">Buat akun karyawan baru</p>
        </div>
    </div>
    ...
    <div class="max-w-2xl">
        <form action="{{ route('admin.karyawan.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm p-6">
            @csrf
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <select name="division" required
                        ...
                        <option value="agency" {{ old('division') == 'agency' ? 'selected' : '' }}>Agency</option>
                        <option value="academy" {{ old('division') == 'academy' ? 'selected' : '' }}>Academy</option>
                    </select>
                </div>
